...
function makeParams(): FittedParams {
  return {
    ...
    tyreDegradation: {
      trackIndex: { "Gen GP": { value: 0.05, provenance: "DERIVED" } },
    ...
    dirtyAirLossPerSecondOfProximity: { "Gen GP": { value: 0.1, provenance: "DERIVED" } },
    pitLoss: { "Gen GP": { netLossSeconds: { value: 22, provenance: "DERIVED" }, iqr: [20, 24] } },
    neutralisation: {
